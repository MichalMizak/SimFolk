...
public class TTermGroup extends TableImpl<TermGroupRecord> {
    ...
    private static final long serialVersionUID = -1079306899;
     ...
     */
    public final TableField<TermGroupRecord, Integer> GROUPID = createField("groupId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
     ...
     */
    @Override
    public Identity<TermGroupRecord, Integer> getIdentity() {
