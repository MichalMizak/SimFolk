...
public class TSong extends TableImpl<SongRecord> {
    ...
    private static final long serialVersionUID = -1123691933;
     ...
     */
    public final TableField<SongRecord, Integer> SONGID = createField("songId", org.jooq.impl.SQLDataType.INTEGER.nullable(false).identity(true), this, "");
    ...
    public List<Index> getIndexes() {
        return Arrays.<Index>asList(Indexes.SONG_PRIMARY);
    }
    ...
    public List<UniqueKey<SongRecord>> getKeys() {
        return Arrays.<UniqueKey<SongRecord>>asList(Keys.KEY_SONG_PRIMARY);
    }
