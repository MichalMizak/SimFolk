...
public class TTermGroupToTerm extends TableImpl<TermGroupToTermRecord> {
     ...
     */
    public final TableField<TermGroupToTermRecord, Long> GROUPID = createField("groupId", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");

    /**
     * The column <code>simfolk.term_group_to_term.termId</code>.
     */
    public final TableField<TermGroupToTermRecord, Long> TERMID = createField("termId", org.jooq.impl.SQLDataType.BIGINT.nullable(false), this, "");
